...
\begin{resume}
\section{OBJECTIVE}  
An internship or full-time position applying my knowlege in mathematics in the field of computers with special interests in applications programming, information processing, and alogithm design. 
...
C, C++, Python, Matlab, Octave, LaTeX, Microsoft Office, Adobe acrobat \\
{\sl Operating Systems:} Linux, Unix, Windows, OSX \\
{\sl Version Control:} Git

\section{OTHER \\ SKILLS} 
Spanish - Fluent speach/reading/writing \\
